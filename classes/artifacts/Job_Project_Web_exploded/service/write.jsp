    ...
    <div class="comm-write-container">
        ...
        <form method="post" action="/service/write_submit.do?id=${sessionScope.id }">
            ...
            <div class="form-section">
                ...
                <textarea id="content" name="content" rows="8" placeholder="내용을 입력하세요"
                          required></textarea>
            </div>

            <!-- 비밀여부 -->
            <div class="flex justify-content-end items-center my-4">
                <input id="visible" type="radio" value="" name="visible"
            ...
            <div class="d-flex justify-content-between">
                <button type="button" class="btn btn-cancel" onclick="writeCancel()">
                    취소하기
                </button>
