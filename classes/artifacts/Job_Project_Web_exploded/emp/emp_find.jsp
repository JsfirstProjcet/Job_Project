		                     ...
		                     <div class="row g-2">
		                         ...
		                         <div class="col-md-4">
		                             <select class="form-select border-0" name="loc">
		                                 ...
		                                 <option value="3" ${param.loc == '3' ? 'selected' : ''}>서울</option>	
		                                 <option value="1" ${param.loc == '1' ? 'selected' : ''}>경기</option>
		                                 <option value="4" ${param.loc == '4' ? 'selected' : ''}>광주</option>
		                                 <option value="14" ${param.loc == '14' ? 'selected' : ''}>대구</option>
		                                 <option value="6" ${param.loc == '6' ? 'selected' : ''}>대전</option>
		                                 <option value="2" ${param.loc == '2' ? 'selected' : ''}>부산</option>
		                                 <option value="9" ${param.loc == '9' ? 'selected' : ''}>울산</option>
		                                 <option value="7" ${param.loc == '7' ? 'selected' : ''}>인천</option>
		                                 <option value="8" ${param.loc == '8' ? 'selected' : ''}>강원</option>
		                                 <option value="5" ${param.loc == '5' ? 'selected' : ''}>경남</option>
		                                 <option value="15" ${param.loc == '15' ? 'selected' : ''}>경북</option>
		                                 <option value="16" ${param.loc == '16' ? 'selected' : ''}>전남</option>
		                                 <option value="12" ${param.loc == '12' ? 'selected' : ''}>전북</option>
		                                 <option value="13" ${param.loc == '13' ? 'selected' : ''}>충남</option>
		                                 <option value="10" ${param.loc == '10' ? 'selected' : ''}>충북</option>
		                                 <option value="17" ${param.loc == '17' ? 'selected' : ''}>제주</option>
		                                 <option value="11" ${param.loc == '11' ? 'selected' : ''}>세종</option>
