...
<div class="container my-5" style="max-width: 800px;">
  ...
  <div class="d-flex align-items-center mb-2">
    <span class="badge bg-secondary me-2">취준/이직</span>
    <span class="badge bg-success">PICK</span>
  </div>

  <!-- 제목 -->
  <h3 class="fw-bold mb-3">요즘 중소는 대체 면접을 왜 이렇게 많이 볼까요...</h3>

  <!-- 작성 정보 -->
  <div class="text-muted mb-4">
    <small>작성 22시간 전 · 조회 157</small>
  </div>

  <!-- 본문 내용 -->
  <p class="mb-4">
    무슨 대기업도 아니고 중소 인원 고작 5명 있으면 AI면접, 직무면접, 인성면접... 대체 몇 단계를 걸치는 걸까요... 
    그렇다고 연봉이 높은 것도 아니고... 진짜 요즘 넘 힘드네요ㅠㅠ
  </p>

  <!-- 해시태그 리스트 -->
  <div class="mb-4">
    <span class="badge bg-light text-dark border me-1">#취업</span>
    <span class="badge bg-light text-dark border me-1">#이직</span>
    <span class="badge bg-light text-dark border me-1">#잡담</span>
    <span class="badge bg-light text-dark border me-1">#면접</span>
    <span class="badge bg-light text-dark border me-1">#채용</span>
  </div>
  ...
  <div class="card p-3 mb-4">
    <div class="d-flex align-items-center">
      <img src="https://via.placeholder.com/50" alt="프로필 이미지" class="rounded-circle me-3">
...
<div class="container my-5" style="max-width: 800px;">
  ...
  <div class="card p-4 mb-4">
    <div class="d-flex align-items-center mb-3">
      <img src="https://via.placeholder.com/40" alt="프로필" class="rounded-circle me-2">
  ...
  <div class="card p-4 mb-3">
    <div class="d-flex mb-3 align-items-center">
      <img src="https://via.placeholder.com/40" alt="댓글 작성자" class="rounded-circle me-2">
      <div>
